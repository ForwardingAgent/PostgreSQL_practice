...
Проект для практики и тестирования различных запросов в базу данных PostgreSQL.
Что сделано в проекте:
- создал в Docker с помощью docker-compose базу данных PostgreSQL и систему pgAdmin4 для администрирования и разработки баз данных PostgreSQL.
- изучил создание/наполнение, изменение базы данных, групповые операции и вложенные запросы, связи между таблицами.
- изучил возможность работы с помощью командной строки, а там же с помощью графического клиента pgAdmin4.
- изучил функционал Github Actions.
- создал в Github Actions возможность запуска контейнеров и создание базы данных по команде git push.
